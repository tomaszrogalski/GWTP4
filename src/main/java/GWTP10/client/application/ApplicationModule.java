...
import GWTP10.client.application.odpowiedz.OdpowiedzModule;
import GWTP10.client.application.pokazpozycje.PokazPozycjeModule;
import GWTP10.client.application.pryzklad1.Pryzklad1Module;
import GWTP10.client.application.przyklad2.Przyklad2Module;
...
public class ApplicationModule extends AbstractPresenterModule {
    ...
    protected void configure() {
		...
		install(new Przyklad2Module());
		install(new Pryzklad1Module());
